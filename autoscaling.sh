...
as-create-auto-scaling-group CIDemoASG --region ap-southeast-2 --launch-configuration CIDemoLaunch --availability-zones ap-southeast-2b --min-size 1 --max-size 10 --desired-capacity 1 --load-balancers cidemo-lb --tag "k=name, v=cidemo, p=true"
